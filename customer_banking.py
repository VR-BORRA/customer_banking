...
def main():
    ...
    savings_maturity = int(input("Enter how many months for savings:"))
    ...
    print(
        f"Interest earned on savings: ${interest_earned:,.2f}  \nSavings Account balance: ${updated_savings_balance:,.2f}"
    )

    # # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    cd_balance = float(input("Enter the CD balance: "))
    cd_interest = float(input("Enter the CD interest rate: "))
    cd_maturity = int(input("Enter how many months for CD: "))
    ...
    print(
        f"Interest earned on CD: ${interest_earned:,.2f}\nCD balance: ${updated_cd_balance:,.2f}"
    )
